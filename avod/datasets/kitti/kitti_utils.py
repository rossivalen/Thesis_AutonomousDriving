...
class KittiUtils(object):
    ...
    def __init__(self, dataset, dst):
        ...
        # Label Clusters
        self.label_cluster_utils = LabelClusterUtils(dst)
        ...
        # Mini Batch Utils
        self.mini_batch_utils = MiniBatchUtils(dst)
    ...
    def class_str_to_index(self, class_str):
        ...
        raise ValueError('Invalid class string {}, not in {}'.format(class_str, clss))
    ...
    def get_anchors_info(self, classes_name, sample_name):
    ...
    def filter_labels(self, objects,
        ...
        for obj_idx in range(len(objects)):
            ...
            # Filter by difficulty (occlusion, truncation, and height) ACTUALLY VISIBILITY TOKEN IL LYFT IS ALWAYS EMPTY
            
#             if difficulty is not None and not self._check_difficulty(obj, difficulty):
#                 filter_mask[obj_idx] = False
#                 continue

#             if max_occlusion and obj.visibility > max_occlusion:
#                 filter_mask[obj_idx] = False
#                 continue
